export class ApplicationError extends Error {
  constructor(message: string, public readonly statusCode: number = 500, public readonly code?: string, public readonly data?: unknown | object) {
    super(message)
...
export class YupDataValidationError extends ApplicationError {
  constructor(message: string, data?: unknown | object) {
...
export class GetStoredCredentialsError extends ApplicationError {
  constructor(message: string, data?: unknown | object) {
    super(message, 500, 'GET_STORED_CREDENTIALS_ERROR', data)
  }
}
...
export class GetNewCredentialsError extends ApplicationError {
  constructor(message: string, data?: unknown | object) {
    super(message, 500, 'GET_NEW_CREDENTIALS_ERROR', data)
  }
}
...
export class ObjectHelperPlaceHoldError extends ApplicationError {
  constructor(message: string, data?: unknown | object) {
    super(message, 500, 'OBJECT_HELPER_PLACEHOLDER_ERROR', data)
  }
}
